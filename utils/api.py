    ...
    def _base_payload(
        ...
        __xlog_data =  {
            ...
            "hw": {
                ...
                "product" : "dream2qltezh",
                "manuf"   : self.__device["device_brand"],
                "tags"    : "release-keys",
                "inc"     : "700220426",
                "des"     : f"dream2qltezh-user 7.1 N2G48H {self.__device['device_serial']}ZHU1AQEE release-keys",
                "bt"      : f"{self.__device['device_serial']}ZHU1AQEE",
                "pfbd"    : "msm8998",
            ...
            "extension" : {
                ...
                "notify": 1,
                "sg_s"  : sg_s,
                "path"  : "package:/data/app/com.zhiliaoapp.musically.go-1/base.apk",
                "bdc"   : "",
                "dp"    : self.__device["dp"],
                "sign"  : sign,
                "sha1"  : "",
